...
var Particle = function (pos, img_) {
    this.loc = pos.copy();
    this.mass = .75 + 1.0 * random();
    this.size = this.mass;
    this.scale = this.mass - .5;
...
Particle.prototype.render = function() {
    imageMode(CENTER);
    tint(255, 240, 0, this.lifespan);

    image(this.texture, this.loc.x, this.loc.y, this.texture.width * this.scale, this.texture.height * this.scale);
}
